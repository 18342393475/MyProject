...
(function (root, factory) {
	...
	var Util = {
		 ...
		 */
		getimg: function(){
			var _imgs = document.getElementById('fenxiang');
			/*
			if(_imgs.length === 0){
				return;
			}
			*/
			return encodeURIComponent(_imgs.src);
		},
	...
	WX.prototype = function() {
		return{
			...
			render: function(){
				...
				this.wxbox.style.cssText = 'position:absolute; left:50%;top:-80px;display:none;';
				document.getElementById('share').appendChild(this.wxbox);
			},
